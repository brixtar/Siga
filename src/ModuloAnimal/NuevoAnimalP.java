 ...
 * @author Ale
 */
public class NuevoAnimalP extends javax.swing.JInternalFrame {
...
//nombre de columnas, tabla, instruccion sql
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("AGREGAR NUEVO ANIMAL PEQUEÑO");
...
//agregamos la nueva raza
	...
	DateFormat fecha = new SimpleDateFormat("yyyy-MM-dd");
        ...
        String life ="si";
        boolean aux = animal.existe("animal_pequenios", "nombre", nombre);
        if (aux==true){
            JOptionPane.showMessageDialog(rootPane, "El registro ya existe");
        }else{
              String datos[] = {nombre,cod_especie,cod_raza,peso,date,sexo,color,dni,life};   
        //array de datos , instruccion sql
        animal.InsertarRegistro(datos, "insert into `animal_pequenios`( `nombre`, `cod_especie`, `cod_raza`, `peso`, `nacimiento`, `sexo`, `color`, `dni_duenio`, `vivo`)values(?,?,?,?,?,?,?,?,?)");
