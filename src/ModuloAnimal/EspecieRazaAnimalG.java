 ...
 * @author BayBay
 */
public class EspecieRazaAnimalG extends javax.swing.JInternalFrame {

    /**
     * Creates new form AMEspecie
     */
    public EspecieRazaAnimalG() {
        initComponents();
    ...
    private void cargarTabla(){
        ...
        dtAnimal = animal.GetTabla(colName, "lista_especieg", "SELECT  *FROM `lista_especieg`");
// se colocan los datos en la tabla
        ...
        //nombre de columnas, tabla, instruccion sql
        dtAnimal = animal.GetTabla(colName, "lista_especieg,lista_razag", "SELECT  *FROM `lista_especieg`,`lista_razag`WHERE `lista_especieg`.`cod_especie` =`lista_razag`.`cod_especie`");
// se colocan los datos en la tabla
        DefaultTableModel datos = new DefaultTableModel(dtAnimal,columNames);                        
        jtEspecie.setModel(datos);
        // se colocan los datos en la tabla
    ...
    private void desbloquearModificar(){
        //jcbEspecie2.setEnabled(true);
        //jcbRaza2.setEnabled(true);
    ...
    private void jbActualizarRazaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbActualizarRazaActionPerformed
        ...
        animal.UpdateRegistro(datos, "UPDATE `lista_razag`SET`raza`=? WHERE `cod_raza`=?");
        cargarTabla();
        cargarRazas();
        cargarRazas2();
    ...
    private void jbActualizarEspecieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbActualizarEspecieActionPerformed
        ...
        animal.UpdateRegistro(datos, "UPDATE `lista_especieg`SET`especie`=? WHERE `cod_especie`=?");
        cargarTabla();
        cargarEspecies();
        cargarEspecies2();  
