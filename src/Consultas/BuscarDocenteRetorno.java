 ...
 * @author BayBay
 */
public class BuscarDocenteRetorno extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDocenteRetorno() {
        initComponents();
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        RetornoAnimalP.jlDocente.setText(apellido);
        RetornoAnimalP.jlDocente1.setText(nombre);
        RetornoAnimalP.jlDocente2.setText(dni);
        }
        this.dispose();
