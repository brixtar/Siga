 ...
 * @author BayBay
 */
public class BuscarDocenteRetornoG extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDocenteRetornoG() {
        initComponents();
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        RetornoAnimalG.jlDocente.setText(apellido);
        RetornoAnimalG.jlDocente1.setText(nombre);
        RetornoAnimalG.jlDocente2.setText(dni);
        }
        this.dispose();
