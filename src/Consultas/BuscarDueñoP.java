 ...
 * @author BayBay
 */
public class BuscarDueñoP extends javax.swing.JInternalFrame {
...
// se colocan los datos en la tabla
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        ConsultaAnimalP.jlApellido.setText(apellido);
        ConsultaAnimalP.jlDni.setText(dni);
        ConsultaAnimalP.jlDomicilio.setText(animal.GetData("domicilio","SELECT domicilio FROM duenio WHERE dni_duenio = \""+dni+"\""));
        ConsultaAnimalP.jlTelefono.setText(animal.GetData("telefono_fijo","SELECT telefono_fijo FROM duenio WHERE dni_duenio = \""+dni+"\""));
        ConsultaAnimalP.jlNombre.setText(animal.GetData("nombre","SELECT nombre FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        ConsultaAnimalP.jlFechaNacimiento.setText(animal.GetData("nacimiento","SELECT nacimiento FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        ConsultaAnimalP.jlPeso.setText(animal.GetData("peso","SELECT peso FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        ConsultaAnimalP.jlSexo.setText(animal.GetData("sexo","SELECT sexo FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        ConsultaAnimalP.jlColor.setText(animal.GetData("color","SELECT color FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        ConsultaAnimalP.jlEspecie.setText(especie);
        ConsultaAnimalP.jlRaza.setText(raza);
        ConsultaAnimalP.jpGeneral.setPreferredSize(new Dimension(813, 259));
        this.dispose();       
        }
