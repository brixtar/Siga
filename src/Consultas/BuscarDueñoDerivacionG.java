 ...
 * @author BayBay
 */
public class BuscarDueñoDerivacionG extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDueñoDerivacionG() {
        initComponents();
...
// se colocan los datos en la tabla
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        DerivacionG.jlApellido.setText(apellido);
        DerivacionG.jlDni.setText(dni);
        DerivacionG.jlDomicilio.setText(animal.GetData("domicilio","SELECT domicilio FROM duenio WHERE dni_duenio = \""+dni+"\""));
        DerivacionG.jlTelefono.setText(animal.GetData("telefono_fijo","SELECT telefono_fijo FROM duenio WHERE dni_duenio = \""+dni+"\""));
        DerivacionG.jlNombre.setText(animal.GetData("nombre","SELECT nombre FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionG.jlFechaNacimiento.setText(animal.GetData("nacimiento","SELECT nacimiento FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionG.jlPeso.setText(animal.GetData("peso","SELECT peso FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionG.jlSexo.setText(animal.GetData("sexo","SELECT sexo FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionG.jlColor.setText(animal.GetData("color","SELECT color FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionG.jlEspecie.setText(especie);
        DerivacionG.jlRaza.setText(raza);
        DerivacionG.jpGeneral.setPreferredSize(new Dimension(813, 259));
        this.dispose();       
        }
