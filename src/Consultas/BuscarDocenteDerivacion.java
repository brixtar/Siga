 ...
 * @author BayBay
 */
public class BuscarDocenteDerivacion extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDocenteDerivacion() {
        initComponents();
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        DerivacionP.jlDocente.setText(apellido);
        DerivacionP.jlDocente1.setText(nombre);
        DerivacionP.jlDocente2.setText(dni);
        }
        this.dispose();
