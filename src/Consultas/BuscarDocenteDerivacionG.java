 ...
 * @author BayBay
 */
public class BuscarDocenteDerivacionG extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDocenteDerivacionG() {
        initComponents();
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        DerivacionG.jlDocente.setText(apellido);
        DerivacionG.jlDocente1.setText(nombre);
        DerivacionG.jlDocente2.setText(dni);
        }
        this.dispose();
