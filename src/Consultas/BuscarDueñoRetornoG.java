 ...
 * @author BayBay
 */
public class BuscarDueñoRetornoG extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDueñoRetornoG() {
        initComponents();
...
// se colocan los datos en la tabla
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        RetornoAnimalG.jlApellido.setText(apellido);
        RetornoAnimalG.jlDni.setText(dni);
        RetornoAnimalG.jlDomicilio.setText(animal.GetData("domicilio","SELECT domicilio FROM duenio WHERE dni_duenio = \""+dni+"\""));
        RetornoAnimalG.jlTelefono.setText(animal.GetData("telefono_fijo","SELECT telefono_fijo FROM duenio WHERE dni_duenio = \""+dni+"\""));
        RetornoAnimalG.jlNombre.setText(animal.GetData("nombre","SELECT nombre FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalG.jlFechaNacimiento.setText(animal.GetData("nacimiento","SELECT nacimiento FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalG.jlPeso.setText(animal.GetData("peso","SELECT peso FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalG.jlSexo.setText(animal.GetData("sexo","SELECT sexo FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalG.jlColor.setText(animal.GetData("color","SELECT color FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalG.jlEspecie.setText(especie);
        RetornoAnimalG.jlRaza.setText(raza);
        RetornoAnimalG.jpGeneral.setPreferredSize(new Dimension(813, 259));
        this.dispose();       
        }
