 ...
 * @author BayBay
 */
public class BuscarDueñoRetorno extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDueñoRetorno() {
        initComponents();
...
// se colocan los datos en la tabla
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        RetornoAnimalP.jlApellido.setText(apellido);
        RetornoAnimalP.jlDni.setText(dni);
        RetornoAnimalP.jlDomicilio.setText(animal.GetData("domicilio","SELECT domicilio FROM duenio WHERE dni_duenio = \""+dni+"\""));
        RetornoAnimalP.jlTelefono.setText(animal.GetData("telefono_fijo","SELECT telefono_fijo FROM duenio WHERE dni_duenio = \""+dni+"\""));
        RetornoAnimalP.jlNombre.setText(animal.GetData("nombre","SELECT nombre FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalP.jlFechaNacimiento.setText(animal.GetData("nacimiento","SELECT nacimiento FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalP.jlPeso.setText(animal.GetData("peso","SELECT peso FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalP.jlSexo.setText(animal.GetData("sexo","SELECT sexo FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalP.jlColor.setText(animal.GetData("color","SELECT color FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        RetornoAnimalP.jlEspecie.setText(especie);
        RetornoAnimalP.jlRaza.setText(raza);
        RetornoAnimalP.jpGeneral.setPreferredSize(new Dimension(813, 259));
        this.dispose();       
        }
