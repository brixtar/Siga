 ...
 * @author BayBay
 */
public class BuscarDueñoDerivacion extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDueñoDerivacion() {
        initComponents();
...
// se colocan los datos en la tabla
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        DerivacionP.jlApellido.setText(apellido);
        DerivacionP.jlDni.setText(dni);
        DerivacionP.jlDomicilio.setText(animal.GetData("domicilio","SELECT domicilio FROM duenio WHERE dni_duenio = \""+dni+"\""));
        DerivacionP.jlTelefono.setText(animal.GetData("telefono_fijo","SELECT telefono_fijo FROM duenio WHERE dni_duenio = \""+dni+"\""));
        DerivacionP.jlNombre.setText(animal.GetData("nombre","SELECT nombre FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionP.jlFechaNacimiento.setText(animal.GetData("nacimiento","SELECT nacimiento FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionP.jlPeso.setText(animal.GetData("peso","SELECT peso FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionP.jlSexo.setText(animal.GetData("sexo","SELECT sexo FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionP.jlColor.setText(animal.GetData("color","SELECT color FROM animal_pequenios WHERE cod_animal = \""+cod_animal+"\""));
        DerivacionP.jlEspecie.setText(especie);
        DerivacionP.jlRaza.setText(raza);
        DerivacionP.jpGeneral.setPreferredSize(new Dimension(813, 259));
        this.dispose();       
        }
