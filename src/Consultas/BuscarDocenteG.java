 ...
 * @author BayBay
 */
public class BuscarDocenteG extends javax.swing.JInternalFrame {

    /**
     * Creates new form EliminarAnimalP
     */
    public BuscarDocenteG() {
        initComponents();
    ...
    private void jbElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbElegirActionPerformed
        ...
        ConsultaAnimalG.jlDocente.setText(apellido);
        ConsultaAnimalG.jlDocente1.setText(nombre);
        ConsultaAnimalG.jlDocente2.setText(dni);
        }
        this.dispose();
